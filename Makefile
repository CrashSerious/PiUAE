...
ACLOCAL = ${SHELL} /home/pi/e-uae-0.8.29-WIP4/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/pi/e-uae-0.8.29-WIP4/missing --run tar
AR = ar
ASMOBJS = 
AUTOCONF = ${SHELL} /home/pi/e-uae-0.8.29-WIP4/missing --run autoconf
AUTOHEADER = ${SHELL} /home/pi/e-uae-0.8.29-WIP4/missing --run autoheader
AUTOMAKE = ${SHELL} /home/pi/e-uae-0.8.29-WIP4/missing --run automake-1.7
AWK = mawk
...
CDOBJS = 
CFLAGS = -g -O2  -fomit-frame-pointer   -Wall -Wno-unused -Wno-format -W -Wmissing-prototypes -Wstrict-prototypes -DREGPARAM=  -DUSE_GL  
CPP = gcc -E
CPPFLAGS =  -I/usr/include  -DFPUEMU -DCPUEMU_0 -DCPUEMU_5 -DCPUEMU_6 -DAGA -DAUTOCONFIG -DFILESYS -DBSDSOCKET -DSUPPORT_THREADS -DUSE_SDL -DFDI2RAW -DDEBUGGER -DSAVESTATE -DENFORCER -DACTION_REPLAY  -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT 
...
LIBS = -lz  -ldl  -L/usr/lib/arm-linux-gnueabihf -lSDL  -lGL -lGLU   -lm
LTLIBOBJS =  ${LIBOBJDIR}fsusage$U.lo
MACHDEP = md-generic
MAKEDEPPRG = not-found
MAKEINFO = ${SHELL} /home/pi/e-uae-0.8.29-WIP4/missing --run makeinfo
MATHLIB = -lm
NO_SCHED_CFLAGS = 
OBJC = gcc
...
install_sh = /home/pi/e-uae-0.8.29-WIP4/install-sh
